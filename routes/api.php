...
//////////////////////////////// Start Pages //////////////////////////////////
    ...
    Route::get('web-champs', 'MainController@webChamps');
    Route::get('champs', 'MainController@champs');
    Route::get('champ/{champ}', 'MainController@champ');
...
//////////////////////////////// Start User //////////////////////////////////
    Route::group(['middleware' => ['auth:api']], function () {
        ...
        Route::get('user/get-subscriptions', [CustomerController::class, 'getSubscriptions']);
