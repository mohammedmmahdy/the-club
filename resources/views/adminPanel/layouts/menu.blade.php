...
<li class="menu-item  {{ Request::is('*academies.requests*') ? 'menu-item-active' : '' }}" aria-haspopup="true" >
    <a href="{{ route('adminPanel.academies.requests') }}" class="menu-link ">
        ...
        <span class="menu-text">Academy Requests <span class="badge badge-pill badge-danger mx-2">{{ $academyRequestsCount}}</span></span>
    </a>
</li>
...
@endphp
<li class="menu-item  {{ Request::is('*event.reservations*') ? 'menu-item-active' : '' }}" aria-haspopup="true" >
    <a href="{{ route('adminPanel.events.reservations') }}" class="menu-link ">
        ...
        <span class="menu-text">Event Reservations <span class="badge badge-pill badge-danger mx-2">{{ $eventReservationsCount}}</span></span>
    </a>
</li>
