...
@can('loyalties view')
    <li class="menu-item  {{ Request::is('*adminPanel/loyalties*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
        <a href="{{ route('adminPanel.loyalties.index') }}" class="menu-link ">
            <span class="svg-icon menu-icon">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                    height="24px" viewBox="0 0 24 24" version="1.1">
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="menu-text">@lang('models/loyalties.plural')</span>
        </a>
    </li>
@endcan

@can('champs view')
    <li class="menu-item  {{ Request::is('*adminPanel/champs*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
        <a href="{{ route('adminPanel.champs.index') }}" class="menu-link ">
            <span class="svg-icon menu-icon">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                    height="24px" viewBox="0 0 24 24" version="1.1">
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="menu-text">@lang('models/champs.plural')</span>
        </a>
    </li>
@endcan
