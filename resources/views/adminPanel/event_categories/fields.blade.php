...
<div class="tab-content mt-5" id="myTabContent">
    ...
    @foreach (config('langs') as $locale => $name)
        ...
        <div class="tab-pane fade {{ $i ? 'show active' : '' }}" id="{{ $name }}" role="tabpanel"
            ...
            <div class="form-group col-sm-6">
                ...
                {!! Form::text($locale . '[name]', isset($eventCategory) ? $eventCategory->translate($locale)->name : '', ['class' => 'form-control', 'placeholder' => $name . ' name']) !!}
            </div>
    ...
    <div class="form-group col-sm-12">
        ...
        <a href="{{ route('adminPanel.eventCategories.index') }}" class="btn btn-default">@lang('crud.cancel')</a>
    </div>
