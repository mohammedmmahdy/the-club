...
<div class="tab-content mt-5" id="myTabContent">
    ...
    @foreach (config('langs') as $locale => $name)
        <div class="tab-pane fade {{ $i ? 'show active' : '' }}" id="{{ $name }}" role="tabpanel"
            ...
            <div class="form-group col-sm-6">
                ...
                {!! Form::text($locale . '[title]', isset($champ) ? $champ->translate($locale)->title : '', ['class' => 'form-control', 'placeholder' => $name . ' title']) !!}
            </div>
            ...
            <div class="form-group col-sm-12 col-lg-12">
                ...
                {!! Form::textarea($locale . '[body]', isset($champ) ? $champ->translate($locale)->body : '', ['class' => 'form-control', 'placeholder' => $name . ' body']) !!}
            </div>

            <script type="text/javascript">
                CKEDITOR.replace("{{ $locale . '[body]' }}", {
    ...
    <div class="form-group col-sm-6">
        ...
        <div class="image-input image-input-outline" id="kt_image_4"
            ...
            <div class="image-input-wrapper" style="background-image: url({{ $champ->photo_original_path ?? '' }})">
            </div>
    ...
    <div class="form-group col-sm-12">
        ...
        <a href="{{ route('adminPanel.champs.index') }}" class="btn btn-default">@lang('crud.cancel')</a>
    </div>
