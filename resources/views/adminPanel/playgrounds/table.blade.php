        ...
        <tr>
            ...
            <td nowrap>
                ...
                <div class='btn-group'>
                    ...
                    <a href="{{ route('adminPanel.playgrounds.show', [$playground->id]) }}" class='btn btn-sm btn-shadow mx-1 btn-transparent-success'><i class="fa fa-eye"></i></a>
                    @endcan
                    @can('playgrounds edit')
                    <a href="{{ route('adminPanel.playgrounds.edit', [$playground->id]) }}" class='btn btn-sm btn-shadow mx-1 btn-transparent-primary'><i class="fa fa-edit"></i></a>
                    @endcan
