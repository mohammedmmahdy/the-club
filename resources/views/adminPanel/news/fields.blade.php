...
<div class="tab-content mt-5" id="myTabContent">
    ...
    @foreach (config('langs') as $locale => $name)
        ...
        <div class="tab-pane fade {{ $i ? 'show active' : '' }}" id="{{ $name }}" role="tabpanel"
            ...
            <div class="form-group col-sm-6">
                ...
                {!! Form::text($locale . '[title]', isset($news) ? $news->translate($locale)->title : '', ['class' => 'form-control', 'placeholder' => $name . ' title']) !!}
            </div>
            ...
            <div class="form-group col-sm-12 col-lg-12">
                ...
                {!! Form::textarea($locale . '[body]', isset($news) ? $news->translate($locale)->body : '', ['class' => 'form-control', 'placeholder' => $name . ' body']) !!}
            </div>
    ...
    <div class="form-group col-sm-12">
        ...
        <a href="{{ route('adminPanel.news.index') }}" class="btn btn-default">@lang('crud.cancel')</a>
    </div>
