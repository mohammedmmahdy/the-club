                ...
                <div class="card-group">
                    ...
                    <div class="card-body text-center">
                        <div>
                            <h2>4GO</h2>
                            <p>
                                <img onError="this.onerror=null;this.src='{{asset('uploads/images/original/default.png')}}';"src="https://techvillageco.com/wp-content/uploads/2020/11/Tech_VIllage_Egypt.png">
                    </p>
                </div>
            </div>
        </div> --}}
