...
<div class="card card-custom gutter-b">
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
        <div class="card-title">
            <h3 class="card-label">
                @lang('models/events.singular') reservations
    ...
    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4">
                                <div class="input-group date" id="kt_datetimepicker_1" data-target-input="nearest">
                                    <input type="text" class="form-control datetimepicker-input" placeholder="From" data-target="#kt_datetimepicker_1" name="event_reservation_from" value="{{old('event_reservation_from', request('event_reservation_from'))}}" />
                            ...
                            <div class="col-sm-4">
                                <div class="input-group date" id="kt_datetimepicker_2" data-target-input="nearest">
                                    <input type="text" class="form-control datetimepicker-input" placeholder="To" data-target="#kt_datetimepicker_2" name="event_reservation_to" value="{{old('event_reservation_to', request('event_reservation_to'))}}" />
        ...
        <table class="datatable datatable-bordered datatable-head-custom table-hover" id="kt_datatable">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{$reservation->strMemberName  ?? ''}}</td>
